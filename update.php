...
if($_POST && empty($_GET["q"])){
	...
	$key = $_POST["lisans_key"];
    
    $url = "https://".$_SERVER['SERVER_NAME'];
	$config = include __DIR__.'/system/install_config.php';
    ...
    if( $conn->connect_errno ):
      ...
      $errorText = $conn->connect_error;
        ...
        glycon_check($key, "https://lisans.glycon.com.tr/", 10);
        $query = '';
        ...
        $config_file = fopen('system/835fa18dc2d7d18b612881e301dca97f.php', 'w');
        fwrite($config_file, "<?php
    
    define('PATH', realpath('.'));
    define('SUBFOLDER', false);
    define('URL', '".$url."');
    define('DINAMICLISANCE', '".$key."');
    ...
    ");
        fclose($config_file);
         ...
         header("Location:" . "/update.php?q=1");
