            ...
            if ( $insert && $update && $insert2 ):
              ...
              $_SESSION["data"]["order"]      = $order_data;
                ...
                if( $settings["alert_newmanuelservice"] == 2 ):
                  ...
                  if( $sendsms ):
                    SMSUser($settings["admin_telephone"],"Sitenizde #".$last_id." idli yeni bir sipariş mevcut!");
                  endif;
                  if( $sendmail ):
                    sendMail(["subject"=>"Bir sipariş.","body"=>"❗ Sitenizde #".$last_id." numaralı yeni bir sipariş mevcut! Lütfen ilgileniniz.","mail"=>$settings["admin_mail"]]);
                  endif;
                endif;
            else:
              $conn->rollBack();
              ...
              if( $service_detail["service_package"] == 1 || $service_detail["service_package"] == 2 ):
                ...
                if( @!$order->order ):
                  ...
                  if( $sendsms ):
                    ...
                    SMSUser($settings["admin_telephone"],"Sitenizdeki bir sipariş gönderilemedi! ".$glyconRand);
                  endif;
                  if( $sendmail ):
                    sendMail(["subject"=>"❗ Bir sipariş gönderilemedi!","body"=>"Sitenizdeki bir sipariş gönderilemedi! Acilen kontrol etmeniz önerilir.","mail"=>$settings["admin_mail"]]);
                  endif;
                  endif;
