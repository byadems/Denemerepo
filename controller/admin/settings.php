...
$menuList = ["Genel" => "general", "Cron Ayarları" => "crons", "Sağlayıcılar" => "providers", "Ödeme Yöntemleri" => "payment-methods", "Modüller" => "modules", "Entegrasyonlar" => "integrations", "Bildirimler" => "alert", "Bonuslar" => "payment-bonuses", ];
    ...
    if ($access):
        ...
        elseif (route(3) == "delete"):
            ...
            if (!countRow(["table" => "service_api", "where" => ["id" => $id]])):
                $error = 1;
                $icon = "error";
                $errorText = "Lütfen geçerli bir sağlayıcı seçin!";
            else:
