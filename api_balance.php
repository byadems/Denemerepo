...
?>			
		<tr <?php if($error == 1 ): echo 'class="grey"'; endif; ?> class="list_item ">
			...
			<td class="p-r">
				...
				<button type="button" class="btn btn-default btn-xs pull-right" data-toggle="modal" data-target="#modalDiv" data-action="edit_provider" data-id="<?=$provider["id"]?>" >Düzenle</button>
			</td>
