<?php include 'header.php'; ?>
 ...
 <div class="container-fluid">
   <div class="row">
     ...
     <li class="active"><a href="/admin/provider_logs">Sağlayıcı Logları</a></li>        
          <li><a href="/admin/guard_logs">Koruma Logları <?php if(countRow(['table'=>'guard_log'])): ?>
                       ...
                       <tbody>
                         ...
                         <?php foreach($logs as $log): $extra = json_decode($log["servicealert_extra"],true); ?>
                          <tr>
                             ...
                             <td> <a href="<?php echo site_url("admin/provider_logs/delete/".$log["id"]) ?>" style="font-size:12px">Sil</a> </td>
                          </tr>
                        <?php endforeach; ?>
                       </tbody>
