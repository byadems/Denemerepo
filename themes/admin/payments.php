...
<div class="container-fluid">
   ...
   <ul class="nav nav-tabs">
        <li class="p-b">
         ...
         <span class="export-title">Bakiye Ekle/Eksilt</span>
         </button>
      </li>
      <li class="pull-right custom-search">
         <form class="form-inline" action="<?php echo site_url("admin/payments/online") ?>" method="get">
            <div class="input-group">
               <input type="text" name="search" class="form-control" value="<?=$search_word?>" placeholder="Ödeme ara...">
      ...
      <li class="pull-right export-li">
         ...
         <span class="export-title"><?php if(countRow(["table"=>"payments","where"=>["payment_method"=>7,"payment_status"=>1]])): ?><span class="badge" style="background-color: #f0ad4e"><?=countRow(["table"=>"payments","where"=>["payment_method"=>7,"payment_status"=>1]]);?></span> <?php endif; ?> Banka Ödeme Bildirimleri</span>
         </a>
      </li>
   </ul>
                 ...
                 <td class="service-block__action">
                   <div class="dropdown pull-right">
                     ...
                     <?php if( $payment["payment_mode"] == "Otomatik" ): ?>
                       <li><a href="#"  data-toggle="modal" data-target="#modalDiv" data-action="payment_detail" data-id="<?php echo $payment["payment_id"] ?>">Ödeme Detayları</a></li>
                     <?php endif; ?>
                       <li><a href="#"  data-toggle="modal" data-target="#modalDiv" data-action="payment_edit" data-id="<?php echo $payment["payment_id"] ?>">Düzenle</a></li>
                     </ul>
                   </div>
                 </td>
              </tr>
