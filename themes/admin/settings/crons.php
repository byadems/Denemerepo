    ...
    <div class="panel panel-default">
                                ...
                                <?php foreach ($cronList as $cronData) { ?>
                                    <tr class="settings-emails__row <?php if ($cronData["cron_status"] != 1) {echo 'grey';} ?>">
                                        ...
                                        <td class="settings-emails__td-actions">
                                            <a href="#" data-toggle="modal" data-target="#edit_crons<?= $cronData["cron_id"] ?>" class="btn btn-default btn-xs pull-right edit_crons">Detaylar</a>
                                        </td>
                                    </tr>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form edit-integration-modal-body">
                                                                <div class="form-group field-editintegrationform-code">
                                                                    <label class="control-label" for="editintegrationform-code">Cron Çalışma Aralığı (Dakika)</label>
                                                                ...
                                                                <div class="form-group field-editintegrationform-visibility">
                                                                    <label class="control-label" for="editintegrationform-visibility">Cron Durumu</label>
                                                                    <select disabled class="form-control" name="visibility">
                                                                        <option value="1" <?php if ($cronData["cron_status"] == 1) {echo 'selected=""';} ?>>Aktif</option>
                                                                        <option value="2" <?php if ($cronData["cron_status"] != 1) {echo 'selected=""';} ?>>Aktif Değil</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control" disabled value="<?= URL."/glycron.php?token=". $keys_key_moto?>">
            </div>
            <div class="col-md-12 help-block">
                <small><i class="fa fa-warning"></i> <code>Cron Key</code> için parola kısmına API Key'inizi yazınız.</small>
