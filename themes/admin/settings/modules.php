...
<?php foreach( $active_modules as $module ){ ?>
                    ...
                    <td class="settings-emails__td-actions">
                        <?php if($module["id"] == 4): ?>
                            <a href="/admin/settings/subject" class="btn btn-default btn-xs pull-right">Düzenle</a>
...
<?php foreach( $passive_modules as $module_1 ){ ?>
 ...
 <tr class="settings-emails__row settings-emails__row-disable">
                        ...
                        <a href="/admin/settings/modules/enable/<?=$module_1["id"]?>">    <button type="button" class="btn btn-default btn-xs pull-right" >Etkinleştir</button> </a>
                        </td>
                    </tr>
