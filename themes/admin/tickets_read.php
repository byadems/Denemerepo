                        ...
                        <div class="col-md-12">
                           ...
                           <input name="username" value="<?=$user["username"]?>" hidden>
                                ...
                                <a href="<?php echo site_url("admin/tickets/close/".$ticketMessage[0]["ticket_id"]) ?>" class="btn btn-default" data-toggle="modal">
                                    ...
                                    <li> <a href="<?php echo site_url("admin/tickets/lock/".$ticketMessage[0]["ticket_id"]) ?>"  data-toggle="tooltip" data-placement="top" title="" data-original-title="Destek talebini kilitle">Talebi Kilitle ve Kapat</a>
                                 </li>  <?php else: ?>
                                     <li><a href="<?php echo site_url("admin/tickets/unlock/".$ticketMessage[0]["ticket_id"]) ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Destek talebi kilidini aç">Talebin kilidini Aç</a>
                                </li>   <?php endif; ?>
                                                                            </ul>
                                                            </div>
                                            </div>
