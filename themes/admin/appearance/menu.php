            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="row settings-menu__row">
                        <div class="col-md-3">
                            <div class="settings-menu__title">Herkese Açık</div>
                            <div class="settings-menu__description">Üye girişi yapmayanlar</div>
                        </div>
                        <div class="col-md-9">
                            <div class="dd">
...
<?php } ?>                                                                     
                    ...
                    <div class="row settings-menu__row">
                        <div class="col-md-3">
                            <div class="settings-menu__title">Sadece Üyeler</div>
                            <div class="settings-menu__description">Giriş yapan kullanıcılar</div>
                        </div>
                        <div class="col-md-9">
                            <div class="dd" >
