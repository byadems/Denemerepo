...
<div class="pull-left">
       ...
       <input type="file" name="logo" accept="image/*"> 
                                    ...
                                    <div class="pull-right">
                                        ...
                                        <button style="margin-bottom: 12px;" type="submit" class="btn btn-default">Dosya Yükle</button>
</div>  </form>   
            </div>
    ...
    <thead>
    <tr>
        <th class="p-l" colspan="2">Dosya</th>
        <th></th>
    </tr>
    </thead>
    <tbody>
<?php foreach( $fileList as $file ){ ?>
    ...
    <tr>
        ...
        <td class="p-r text-right">
            <a class="btn btn-default btn-xs delete-file " href="/admin/appearance/files/delete/<?=$file['id']?>">Sil</a>        </td>
    </tr>
<?php } ?>
    </tbody>
</table>
