...
<div class="col-md-8">
  <div class="settings-header__table">
    <a href="<?php echo site_url("admin/appearance/language/new") ?>"  class="btn btn-default m-b">Yeni Dil Ekle</a>
  </div>
   <table class="table report-table" style="border:1px solid #ddd">
      <thead>
         <tr>
                <th><div style="float:left;">Dil Adı</div></th>
            <th>Statü</th>
            <th></th>
         </tr>
      </thead>
      <tbody>
         ...
         <tr class="<?php if( $language["language_type"] == 1 ): echo 'grey'; endif; ?>">
            <td><div style="float:left;"> <?php echo $language["language_name"]; if( $language["default_language"] == 1 ): echo ' <span class="badge">Aktif</span>'; endif; ?></div> </td>
          ...
          <div class="language-editor__container-footer">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    ...
                                    <button type="submit" id="edit-language-btn" class="btn btn-primary" name="save-button">Güncelle</button>   
                                      <a href="/admin/appearance/language" class="btn btn-default">Geri</a></div>
                            </div>
                    </div>
         </form>
                    ...
                    <div class="row"><div class="language-editor__header-title">
                        <div class="col-md-6">
                         ...
                         <strong><?php echo $language["language_name"] ?></strong>
										<?php if( $language["default_language"] == 1 ): echo ' <span class="badge">Aktif</span>'; endif; ?>
