...
<div class="col-md-2 col-md-offset-1">
            <ul class="nav nav-pills nav-stacked p-b">
                              <li class="settings_menus "><a href="<?=site_url("admin/appearance/pages")?>">Sayfalar</a></li>
                              <li class="settings_menus "><a href="<?=site_url("admin/appearance/news")?>">Duyurular</a></li>
                              <li class="settings_menus "><a href="<?=site_url("admin/appearance/blog")?>">Blog</a></li>
                              <li class="settings_menus "><a href="<?=site_url("admin/appearance/menu")?>">Menü</a></li>
                              <li class="settings_menus active"><a href="<?=site_url("admin/appearance/themes")?>">Temalar</a></li>
                              <li class="settings_menus "><a href="<?=site_url("admin/appearance/language")?>">Diller</a></li>
                               <li class="settings_menus "><a href="<?=site_url("admin/appearance/files")?>">Dosyalar</a></li>
                          </ul>
          </div>
<div class="container">
                <div class="row">
         ...
         ?>
              <div class="col-lg-4 col-md-6 col-sm-6">
                  ...
                  <div class="settings-themes__card--activate">
                                            <a class="btn btn-primary" href="<?php echo site_url('admin/appearance/themes/active/'.$theme["theme_dirname"]) ?>">Aktif Et</a>                                        </div>
                  <?php endif; ?>
                                ...
                                <div class="settings-themes__card-title">
                                    ...
                                    <a href="<?php echo site_url('admin/appearance/themes/'.$theme["theme_dirname"]) ?>" class="btn btn-default btn-xs pull-right">Düzenle</a>
                                </div>
